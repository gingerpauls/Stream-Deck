...
// Prototype which represents a profile action
function ProfileAction(inContext, inSettings) {
	// Inherit from Action
	...
	this.onKeyUp = function(inData, inCallback) {
		...
		actionOnKeyUp.call(this, inData, changeProfile);
		inCallback();
	};

	// Private function called for the change profile request
	function changeProfile(account, target, callback) {
		var url = "https://streamlabs.com/api/v1.0/alert_profiles/activate";
