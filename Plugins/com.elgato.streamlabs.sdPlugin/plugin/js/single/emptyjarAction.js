...
// Prototype which represents an empty jar action
function EmptyJarAction(inContext, inSettings) {
	// Inherit from Action
	...
	this.onKeyUp = function(inData, inCallback) {
		...
		actionOnKeyUp.call(this, inData, emptyJar);
		inCallback();
	};

	// Private function called for the empty jar request
	function emptyJar(account, target, callback) {
		var url = "https://streamlabs.com/api/v1.0/jar/empty";
