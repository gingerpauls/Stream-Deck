...
// Prototype which represents a skip video action
function SkipVideoAction(inContext, inSettings) {
	// Inherit from Action
	...
	// Private function called for the skip video request
	function skip(account, target, callback) {
		var url = "https://streamlabs.com/api/v1.0/media-share/skip-video";
