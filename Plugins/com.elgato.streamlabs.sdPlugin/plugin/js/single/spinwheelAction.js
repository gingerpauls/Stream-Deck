...
// Prototype which represents a spin wheel action
function SpinWheelAction(inContext, inSettings) {
	// Inherit from Action
	...
	this.onKeyUp = function(inData, inCallback) {
		...
		actionOnKeyUp.call(this, inData, spinWheel);
		inCallback();
	};

	// Private function called for the spin wheel request
	function spinWheel(account, target, callback) {
		var url = "https://streamlabs.com/api/v1.0/wheel/spin";
